<template>
    <div>
        <button
            class="button-icon-button button-shadow clickable"
            @click="newChat"
        >
            ...
            <div class="button-icon-button-text">新的对话</div>
        </button>
    </div>
</template>
...
const newChat_ = inject("new-chat");
const clearMsg = inject("clear-msg");

const newChat = (event) => {
    event.preventDefault();
    newChat_(moment().format("YYYY/MM/DD HH:mm:ss"));
    clearMsg();
};
</script>
